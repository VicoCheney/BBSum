...
def main_parser(parser):
    ...
    parser.add_argument('--num_samples', type=str, default='3,3', help='num of continous, discrete random samples and promising samples')
    ...
    parser.add_argument('--train_source', type=str, default=os.path.join(os.getcwd(), 'data', 'arxiv_train.pkl'), help='training dataset')
    parser.add_argument('--test_source', type=str, default=os.path.join(os.getcwd(), 'data', 'arxiv_test.pkl'), help='test dataset')
    parser.add_argument('--validation_source', type=str, default=os.path.join(os.getcwd(), 'data', 'arxiv_validation.pkl'), help='validation dataset')
    parser.add_argument('--only_train', action='store_true')
    parser.add_argument('--only_evaluate', action='store_true')
    parser.add_argument('--lr1', type=float, default=2e-5, help='learning rate of BERT')
    parser.add_argument('--bert_batch_size', type=int, default=32, help='gradient batch_size')
    parser.add_argument('--lr2', type=float, default=2e-5, help='learning rate of BART')
